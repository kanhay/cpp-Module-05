...
/*   Updated: 2024/02/24 14:13:48 by khanhayf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Bureaucrat::signForm(AForm& ob){
    try{
        ob.beSigned(*this);
        std::cout << _name << " signed " << ob.getName() << "\n";
    }
    catch (std::exception& excp){
        std::cout << _name << " couldn't sign " << ob.getName() << " because " << excp.what() << "\n";
    }
}
...
void    Bureaucrat::executeForm(AForm const & form){
    try{
        ...
        std::cout << "Exception happened; " << excp.what() << "\n";
    }
}
